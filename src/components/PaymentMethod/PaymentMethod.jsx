...
const paymentOptions = [
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path
          d="M12.24 10.285V14.4h6.806c-.275 1.765-2.056 5.174-6.806 5.174-4.095 0-7.439-3.389-7.439-7.574s3.345-7.574 7.439-7.574c2.33 0 3.891.993 4.785 1.849l3.254-3.138C18.189 1.186 15.479 0 12.24 0c-6.635 0-12 5.365-12 12s5.365 12 12 12c6.926 0 11.52-4.869 11.52-11.726 0-.788-.085-1.39-.189-1.989H12.24z"
          fill="currentColor"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path
          d="M2 4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h20c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2H2zm0 2h20v2H2V6zm0 4h20v8H2v-8zm2 2v1h4v-1H4zm6 0v1h2v-1h-2z"
          fill="currentColor"
        />
      </svg>
    ),
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        {}
        <div className="px-6 py-5 bg-linear-to-r from-indigo-50 to-purple-50 border-b border-gray-100">
            ...
            >
              ...
              <div
                className={`absolute inset-0 rounded-xl pointer-events-none transition-opacity duration-300 ${
                  hoveredOption === value
                    ? "bg-linear-to-r from-indigo-100/50 to-purple-100/50 opacity-100"
                    : "opacity-0"
                }`}
              />
            </label>
        ...
        {selected && (
          <div className="px-6 pb-6">
            ...
            >
              Continue with{" "}
              {paymentOptions.find((opt) => opt.value === selected)?.label}
            </button>
          </div>
        )}
      </div>
